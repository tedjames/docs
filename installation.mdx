...
- MCP Client Application (Cursor, Windsurf, Cline, Continue, Zed, Claude Desktop)
...
2. Make sure you're running the **@agentdeskai/browser-tools-server** command in a new terminal and that it says:
   > `Aggregator listening on http://127.0.0.1:3025`
...
3. Contact [@tedx_ai](https://x.com/tedx_ai) on X or add an issue to the [Github repo](https://github.com/AgentDeskAI/browser-tools-mcp) with all the requested details and we'll get back to you as soon as possible!
