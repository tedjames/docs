...
3. Contact [@tedx_ai](https://x.com/tedx_ai) on X or add an issue to the [Github repo](https://github.com/AgentDeskAI/browser-tools-mcp) with all the requested details and we'll get back to as soon as possible!
